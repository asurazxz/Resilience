...
function TransactionEditor() {
  ...
  if (transactionId && !existing) return <Shell><section className="mx-auto max-w-xl card"><p className="eyebrow">Transaction unavailable</p><h1 className="mt-2 display-lg" style={{ fontSize: "28px" }}>This transaction no longer exists</h1><p className="mt-3 body-text prose">It may have been deleted or is not part of your account.</p><Link className="button-primary mt-6 inline-flex" to="/transactions">Back to transactions</Link></section></Shell>;
  return (
    <Shell>
